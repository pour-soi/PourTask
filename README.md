...
1. Download `PourTask-v1.2.0-Windows-Setup.exe` or `PourTask-v1.2.0-Windows.zip` from the latest stable release.
...
- `release\PourTask-v1.2.0-Windows\`
- `release\PourTask-v1.2.0-Windows.zip`
- `release\PourTask-v1.2.0-Windows.zip.sha256`
- `release\PourTask-v1.2.0-Windows-Setup.exe`
- `release\PourTask-v1.2.0-Windows-Setup.exe.sha256`
